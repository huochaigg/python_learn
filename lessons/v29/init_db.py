"""
文件作用：创建 python_learn_v29 的 products 表并幂等写入测试库存。
实际意义：FastAPI Agent Tool 要查真实 MySQL，必须先有表和 SKU001/002/003。
运行命令：uv run python lessons/v29/init_db.py
...
from app.core.database import engine, init_schema, seed_products, AsyncSessionLocal
